#!/usr/bin/env python
# -*- coding: utf-8 -*-
# Last-Updated : <2014/01/04 05:57:27 by samui>
...
app = webapp2.WSGIApplication([
    ...
    webapp2.Route(r'/my/edit/<ID:\d+>', handler=handler.MyMethod.Edit, name='my_edit'),
    ...
    webapp2.Route(r'/my/delete/<ID:\d+>', handler=handler.MyMethod.Delete, name='my_delete'),
],debug=True)
